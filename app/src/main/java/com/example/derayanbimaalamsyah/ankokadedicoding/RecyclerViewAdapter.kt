...
class RecyclerViewAdapter(private val context: Context, private val items: List<ItemClub>) : RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) : ViewHolder =
    ViewHolder(ItemListUI().createView(AnkoContext.create(parent.context, parent)))
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        val image: ImageView = view.find(R.id.img_club)
